...
PYTHON_SOURCES = (
    ROOT / "scripts" / "blender" / "repair_ch101_local_crossing.py",
    ...
    ROOT / "scripts" / "blender" / "fit_ch101_hand_saber_pair.py",
    ROOT / "scripts" / "blender" / "refine_ch101_hand_wrist_study.py",
    ROOT / "scripts" / "blender" / "build_ch101_hand_authoring_study.py",
    ROOT / "scripts" / "blender" / "inspect_ch101_attachment_surface.py",
    ...
    ROOT / "scripts" / "blender" / "build_ch101_equipment_study.py",
    ...
    ROOT / "scripts" / "ai3d" / "run_review_remediation_chain.py",
...
NOTEBOOK_MARKERS = (
    ...
    "run_review_remediation_chain.py",
    "RE_CAMP_REVIEW_REMEDIATION_CHAIN",
    "MAX_ATTEMPTS",
